...
public class WorkoutSaveActivity extends AppCompatActivity {
    ...
    private WorkoutwarriorRepo.Callback postWorkoutCallback = new WorkoutwarriorRepo.Callback() {
        @Override
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnPostWorkouts.setOnClickListener(v -> {
            if (!exerciseList.isEmpty()) {
                ...
                repo.postWorkout(srv, handler, userId, exerciseList, postWorkoutCallback);
